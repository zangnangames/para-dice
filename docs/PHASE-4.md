...
- [x] 4-1. 전적 & 프로필 페이지
- [x] 4-2. 덱 통계 (주사위별 승률 분석)
- [~] ~~4-3. 친구 초대 링크 / 비공개 방~~ (기획 제외)
- [x] 4-4. Docker 컨테이너화
- [x] 4-5. GitHub Actions CI/CD 파이프라인
- [x] 4-6. Railway + Vercel 배포 (운영 중)
- [x] 4-7. Rate limiting + 어뷰징 감지
- [x] 4-8. 에러 모니터링 (Sentry)
- [x] 4-9. Lighthouse 성능 최적화
