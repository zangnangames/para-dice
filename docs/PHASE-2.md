...
- [ ] 2-1. PostgreSQL + Prisma 스키마 설계
- [ ] 2-2. `@dice-game/server` 패키지 초기화 (Fastify)
- [ ] 2-3. Google OAuth 인증 (로그인 / 신규 계정 생성)
- [ ] 2-4. 덱 CRUD API
- [ ] 2-5. Socket.io 게임룸 기본 구조
- [ ] 2-6. 드래프트 이벤트 (3개 선택 + 순서 봉인 동기화)
- [ ] 2-7. 라운드 진행 이벤트 (서버 검증 + 결과 브로드캐스트)
- [ ] 2-8. 게임 결과 DB 저장 + 유저/덱 통계 갱신
